...
const FooterPokemon = pokemon => {
  ...
  return (
    <div className="group -ml-[2vw] flex w-[15vw] cursor-pointer flex-col rounded-xl  bg-gradient-to-b pt-2 text-center font-sans text-white duration-200 ease-in-out hover:-translate-y-4 hover:from-blue-900 hover:via-red-900 hover:to-white active:-translate-y-2">
